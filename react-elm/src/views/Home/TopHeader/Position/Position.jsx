...
const Position = ({ position }) => (
  <div className="position" label={`当前地址：${position.name}，轻点两下重新选择`} role='button'>
    <svg className="icon-map" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 31">
      <path
        fill="#FFF"
        fillRule="evenodd"
    ...
    <svg className="icon-dropdown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 8">
      <path
        fill="#FFF"
        fillRule="evenodd"
